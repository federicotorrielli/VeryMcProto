package verymc.top.veryMcProto.mod.servux.util.data;
...
/**
 * MC 数据版本 ↔ 版本字符串映射表。移植自原版 {@code ORIGIN/util/data/Schema.java}（照抄，仅改 package）。
 *
 * <p>A Utility Table of Minecraft Data Versions and their respective Version strings.
 * -
