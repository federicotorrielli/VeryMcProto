...
/**
 * Minecraft Data Version ↔ 版本字符串映射表（移植自 {@code ch.endte.syncmatica.litematica.schematic.Schema}）。
 *
 * <p>Cloned from MaLiLib 1.21.5 -- Sakura。
 * 用于把投影文件的 MinecraftDataVersion 映射到可读版本字符串（如 4671 → "1.21.11"）。
 */
public enum Schema implements StringRepresentable
{
    ...
    SCHEMA_26_1_SS1     (4764, "26.1-snapshot-1"),
    SCHEMA_1_21_11 (4671, "1.21.11"),
    ...
    public static final StringRepresentable.EnumCodec<Schema> CODEC = StringRepresentable.fromEnum(Schema::sorted);
